...
{
        // Seems like a good place to randomly decide to loop.
        int i = 0;

        // this is a dummy check to generate the LLVM IR for the loop invariant
        int loop_inv = i >= 0 & i <= 100000;

        // keep clang from unrolling the loop
